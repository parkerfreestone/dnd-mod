...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_MAGMATITE_ORE = registerKey("add_magmatite_ore");
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_MAGMATITE_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_NETHER),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.NETHER_MAGMATITE_ORE_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_ORES
        ));
    }
