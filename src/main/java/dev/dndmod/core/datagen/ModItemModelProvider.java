...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        handheldItem(ModItems.ORC_TOOTH_SHOVEL);
        handheldItem(ModItems.ORC_TOOTH_HOE);

        trimmedArmorItem(ModItems.MAGMATITE_HELMET);
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = DNDMod.MOD_ID; // Change this to your mod id
